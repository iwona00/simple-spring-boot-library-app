package pl.javaspringboot.libraryapp.library.configuration.security.filters;
...
public class JSONWebTokenFilter extends BasicAuthenticationFilter {
    ...
    private String getHeaderFromRequest(HttpServletRequest request) {return request.getHeader("Authorization");}
